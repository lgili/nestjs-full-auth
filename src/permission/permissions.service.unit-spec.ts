...
describe('PermissionsService', () => {
  ...
  describe('create', () => {
    it('should create a new permission entity using CreatePermissionDto', async () => {
      const permission = await service.create(mockPerimissionDto);
  ...
  describe('whereInIds', () => {
    it('should get Permission array by provided array of id', async () => {
      const ids = ['test1', 'test2'];
      const permission = await service.whereInIds(ids);
